...
abstract class $TaskCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String title, bool isCompleted, DateTime? reminderTime});
}
...
class _$TaskImpl with DiagnosticableTreeMixin implements _Task {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Task(id: $id, title: $title, isCompleted: $isCompleted, reminderTime: $reminderTime)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, isCompleted, reminderTime);
...
abstract class _Task implements Task {
  const factory _Task(
      ...
      final bool isCompleted,
      final DateTime? reminderTime}) = _$TaskImpl;
